...
public class Registration extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // BasicDBObject where= new BasicDBObject();
        BasicDBObject doc =new BasicDBObject("uname",jTextField1.getText())
                                                                .append("Age", jTextField2.getText())
                                                                   .append("city",jTextField3.getText())
                 .append("eid",jTextField4.getText()) .append("pass",jPasswordField1.getText()) 
                .append("cpass",jPasswordField2.getText());
                            coll.insert(doc);
